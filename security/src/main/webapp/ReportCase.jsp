    ...
    <div class="container">
      <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  		...
  		<li class="nav-item active">
    		  <a class="nav-link" href="#">Record Case</a>
   			 </li>
    		<li class="nav-item ">
    		...
    		<li class="nav-item">
    		  <a class="nav-link" href="Display?page=1">RecordedCases</a>
    		</li>
		    ...
		    <div class="container">    
				<div class="row" style="background:white"> 
		            ...
		            <!-- Parsley Validation -->
		               ...
		               <form id="validate_form" action="DataServlet" method="post" data-parsley-validate>
