  		...
  		<ul class="navbar-nav">
    		<li class="nav-item ">
    		  ...
    		  <a class="nav-link" href="Addguard.jsp">Add Guard</a>
   			  ...
   			  <li class="nav-item">
    		  <a class="nav-link" href="GuardsDisplay?page=1">Guards Data</a>
   			 </li>
		    ...
		    <div class="container">    
				<div class="row" style="background:white"> 
		            ...
		            <div class="col-lg-6 col-sm-6 col-md-6">
		               ...
		               <form id="validate_form" action="GuardsServlet" method="post" data-parsley-validate>
		                	<h3 class="text-center">Register Guard here</h3>

								  <div class="form-group">
									    <label for="regno">Security Staff Id:</label>
									    <input type="text" class="form-control" name="id" required data-parsley-pattern="^[a-zA-Z0-9]+$" data-parsley-length="[4, 15]" data-parsley-trigger="keyup">
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
									    ...
									    <input type="text" class="form-control" name="phoneno" required  data-parsley-pattern="[0][7][0-9]{8}" data-parsley-trigger="keyup">
								  </div>
								  &nbsp
								<div class="span4">
