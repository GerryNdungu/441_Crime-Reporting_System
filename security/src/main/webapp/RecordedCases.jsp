  ...
  <ul class="navbar-nav">
   <li class="nav-item ">
    		...
    		<li class="nav-item active">
    		  <a class="nav-link" href="#">RecordedCases</a>
    		</li>
		...
		%>					  
				  ...
				  <nav aria-label="Page navigation example">
					  <ul class="pagination">
					    ...
					    <li class="page-item"><a class="page-link" href="Display?page=1">1</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=2">2</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=3">3</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=4">4</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=5">5</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=5">6</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=5">7</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=5">8</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=5">9</a></li>
					    <li class="page-item"><a class="page-link" href="Display?page=5">10</a></li>
